...
} from "@/app/(home)/components/projects-form/schema";
import { useInitialProjectsFromSearchParams } from "@/app/(home)/utils/search-params";
...
export default function Home() {
  ...
  const isSearchActive = selectedProjects.length > 0;
        ...
        {!isSearchActive && (
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-base text-muted-foreground">
              Analyze and compare download statistics for thousands of
              JavaScript packages. Get insights on React, Vue, Angular, and more
              with interactive charts and real-time data.
            </p>
          </div>
        )}
          ...
          <div className="space-y-12">
            <section className="text-center">
              ...
              <div className="mx-auto max-w-4xl space-y-8 text-muted-foreground">
                <p>
                  Package Pulse provides comprehensive analytics for NPM
                  packages by collecting and analyzing download statistics from
                  the official NPM registry. The platform processes millions of
                  data points to help developers make informed decisions about
                ...
                <div className="grid gap-8 md:grid-cols-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm">
                      Visualize download trends with customizable charts,
                      compare multiple packages side-by-side, and export data
                      for your reports.
                    </p>
                  </div>
                  <div className="space-y-2">
                    ...
                    <p className="text-sm">
                      Get insights into package popularity, growth rates,
                      version adoption, and community engagement metrics from
                      GitHub.
                    </p>
                  </div>
                </div>
            ...
            <section className="text-center">
              ...
              <div className="mx-auto max-w-4xl text-muted-foreground">
                <p className="mb-6">
                  ...
                  testing frameworks, or researching the latest JavaScript
                  tools, Package Pulse provides the data-driven insights you
                  need to make confident technology decisions.
                </p>
                <div className="grid gap-6 md:grid-cols-3">
                  <div className="rounded-lg border p-4">
                    ...
                    <p className="text-sm">
                      Compare competing libraries and frameworks to choose the
                      most suitable option for your project based on popularity
                  ...
                  <div className="rounded-lg border p-4">
                    ...
                    <p className="text-sm">
                      Identify emerging technologies, track the decline of
                      legacy packages, and stay ahead of industry trends with
                      comprehensive download data.
                    </p>
                  </div>
                  <div className="rounded-lg border p-4">
                    <h3 className="mb-2 font-semibold text-foreground">
